...
- `GEMINI.md` — Primary project context document; canonical source for terminology, architecture, and constraints. Keep it in sync with the Locked Decisions in this file.
...
Prefer the freshest meeting minutes when terminology, decisions, or deadlines conflict with what's in GEMINI.md — then propose updating GEMINI.md to match.
